...
// Проходим по карточкам и даем им классы
...
<button class="wrapper-hero-slider__button prev">
  <svg width="31" height="31">
    <use xlink:href="./img/sprites/sprites.svg#button"></use>
  </svg>
</button>
<div class="hero-slider swiper">
  <div class="hero-slider__wrapper swiper-wrapper">
    <div class="hero-slider__slide swiper-slide rd-upload">
      <img src="." data-rd-image="./img/svg/pay-1.svg" width="51" height="25" alt="Icon pay">
    </div>
    <div class="hero-slider__slide swiper-slide rd-upload">
      <img src="." data-rd-image="./img/svg/pay-2.svg" width="51" height="25" alt="Icon pay">
    </div>
  </div>
</div>
<button class="wrapper-hero-slider__button next">
  <svg width="31" height="31">
    <use xlink:href="./img/sprites/sprites.svg#button"></use>
  </svg>
</button>
